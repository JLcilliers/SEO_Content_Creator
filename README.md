...
- **Model**: Uses `claude-sonnet-4-5-20250929` (Claude Sonnet 4.5, latest as of Sep 2025) by default for best quality. Falls back to `claude-3-5-sonnet-20240620` if unavailable.
